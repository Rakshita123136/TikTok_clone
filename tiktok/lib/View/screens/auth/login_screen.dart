...
import 'package:tiktok/View/screens/auth/signup_screen.dart'; // Importing the Signup screen
import 'package:tiktok/View/widgets/text_input_field.dart'; // Importing custom text input field widget
import 'package:tiktok/Controller/auth_controller.dart'; // Importing the authentication controller
          ...
          children: [
            ...
            Container(
              ...
              child: TextInputField(
                controller:
                    _emailController, // Connects input field to controller
                labelText: 'Email',
            ...
            Container(
              width:
                  ...
                  40, // Slightly smaller than full width
